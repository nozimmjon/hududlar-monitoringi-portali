...
OUT_HTML = ROOT / "platform prototypes" / "andijon_integrated_platform_v6_3.html"
...
<head>
  ...
  <title>Андижон вилояти мониторинг платформаси · v6.3</title>
  <style>
    :root {
      --bg: #f7f5f0;
      --paper: #ffffff;
  ...
  <script>
    ...
    function renderPovertyDetails() {
      ...
      return `<div class="drivers">
        ...
        <div class="driver-grid">
          <div class="driver-card"><span>Туманлар мониторинги</span><strong>${fmt(clearTerritories.length, 0)} та</strong><small>холи ҳудуд режада; туманлар кесими юқоридаги workflow орқали очилади</small></div>
        </div>
      </div>`;
    }
    ...
    function setPageMeta() {
      const meta = {
        dashboard: ["KPI", "Йиллик режа, чораклар кесими, боғланган топшириқлар ва туманлар drill-down."],
