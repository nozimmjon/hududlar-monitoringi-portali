...
OUT_HTML = ROOT / "platform prototypes" / "andijon_integrated_platform_v7_1.html"
...
<head>
  ...
  <title>Андижон вилояти мониторинг платформаси · v7.1</title>
  <style>
    :root {
      --bg: #f4f7fb;
      --paper: #ffffff;
    ...
    * { box-sizing: border-box; }
    ...
    .module-tab:hover {
      ...
      box-shadow: inset 0 -4px 0 var(--blue), 0 10px 24px rgba(28, 55, 90, .08);
      color: var(--blue);
    }
...
<body>
  ...
  <script>
    ...
    function evidenceStorageKey(taskId) {
      return `andijon-v71-evidence:${taskId}`;
    }

    const REPORT_KEY = "andijon-v71-execution-reports";
