...
OUT_HTML = ROOT / "platform prototypes" / "andijon_integrated_platform_v7_2.html"
...
<head>
  ...
  <title>Андижон вилояти мониторинг платформаси · v7.2</title>
  <style>
    :root {
      --bg: #eef3f1;
      --paper: #fbfdfc;
      ...
      --grey: #6c716f;
      --grey-soft: #edf0ef;
      --shadow: 0 1px 2px rgba(20, 33, 30, .05), 0 10px 28px rgba(20, 33, 30, .06);
      --nav-w: 244px;
      --r: 8px;
      --radius: var(--r);
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      color: var(--ink);
      background:
        linear-gradient(90deg, rgba(23, 34, 31, .035) 1px, transparent 1px) 0 0 / 48px 48px,
        linear-gradient(180deg, #fbfdfc 0%, var(--bg) 54%, #e8efec 100%);
      overflow-x: hidden;
    }
    ...
    .topbar {
      ...
      box-shadow: 0 1px 0 rgba(20, 33, 30, .04);
    ...
    .mast::after {
      ...
      opacity: .34;
      background:
        linear-gradient(90deg, transparent 0 18px, rgba(31, 95, 147, .22) 18px 19px, transparent 19px 42px) 0 0 / 42px 100%;
      pointer-events: none;
    }
    ...
    .nav-btn:hover {
      ...
      box-shadow: inset 3px 0 0 #79b38f;
    }

    .main {
      min-width: 0;
      padding: 20px clamp(14px, 2.5vw, 34px) 36px;
    }
    ...
    .module-tab:hover {
      background: var(--paper);
      border-color: rgba(35, 113, 77, .38);
    ...
    .front-kpis.module-kpis.macro-layout .front-kpi.parent {
      background: linear-gradient(180deg, var(--paper), #eef6f1);
    }
    ...
    .flow-step.active { border-color: var(--green); background: var(--green-soft); box-shadow: none; }
    .flow-step span { color: var(--green); font-size: 12px; font-weight: 950; }
    ...
    tr.clickable:hover { background: #f2f7f4; }
    ...
    .district-card:hover,
    .district-card.active { border-color: var(--green); background: #f3f8f5; }
    ...
    .mini-button.profile {
      min-height: 34px;
      padding: 7px 10px;
      border-color: rgba(35, 113, 77, .28);
      color: var(--green);
      background: var(--green-soft);
    }
    ...
    .quarter-row.actual { border-color: #9fc8af; background: #f2f8f4; }
    .quarter-row.planned { background: var(--paper); }
    .quarter-row.empty { background: #f4f7f6; }
    ...
    .profile-hero {
      ...
      border-bottom: 1px solid var(--line);
      background:
        linear-gradient(135deg, rgba(35, 113, 77, .10), rgba(255,255,255,0) 58%),
        var(--paper);
    }
    ...
    .link-box.active { border-color: var(--green); background: var(--green-soft); }
...
<body>
  ...
  <script>
    ...
    function evidenceStorageKey(taskId) {
      return `andijon-v72-evidence:${taskId}`;
    }

    const REPORT_KEY = "andijon-v72-execution-reports";
