...
OUT_HTML = ROOT / "platform prototypes" / "andijon_integrated_platform_v6_4.html"
...
<head>
  ...
  <title>Андижон вилояти мониторинг платформаси · v6.4</title>
  <style>
    :root {
      --bg: #f7f5f0;
      --paper: #ffffff;
    ...
    <div class="mast">
      <div class="brand">
        ...
        <div>
          ...
          <p>KPI · топшириқлар · туманлар мониторинги</p>
        </div>
      </div>
  ...
  <div class="shell">
    <aside class="sidebar">
      <div class="side-title">
        ...
        <span>KPI, топшириқ ва туманлар кесимида ижрони кузатиш.</span>
      </div>
  ...
  <script>
    ...
    function openTaskModal(taskId) {
      ...
      $("#taskModal").innerHTML = `
        <div class="modal-head">
          <div>
            <div class="modal-title" id="taskModalTitle">${h(cleanTaskTitle(task.title))}</div>
            <div class="modal-sub">${h(task.sector)} · ${h(task.period)} · ${h(task.owner)}</div>
          </div>
        ...
        <div class="modal-body">
          <div class="modal-grid">
            ...
            <div class="modal-field"><span>Жавобгар</span><strong>${h(task.owner || "—")}</strong></div>
      ...
      $("#tasksPage").innerHTML = `
        ...
        <div class="task-workspace">
          ...
          <aside class="task-focus">
            ...
            <h3>${kpi.short}: бажарилиши керак бўлган ишлар</h3>
            <p>Бу ерда танланган KPIга боғланган топшириқлар ва уларнинг ҳолати кўринади.</p>
            <div class="task-list" style="margin-top:14px">
              ...
              <article class="task-card"><header><strong>3. Туманлар кесими</strong><span class="chip ${districtReady ? "green" : "grey"}">${districtReady ? "бор" : "йўқ"}</span></header><div class="task-meta"><span>${districtReady ? "туманлар бўйича кўриш мумкин" : "туман кўрсаткичи берилмаган"}</span></div></article>
            </div>
          </aside>
        </div>`;
    ...
    function districtTableRow(item, kpi, cfg) {
      ...
      return `<tr class="clickable ${active}" data-select-district="${d.name}">
        ...
        <td><button class="mini-button" data-profile-district="${d.name}">Очиш</button></td>
      </tr>`;
    }
    ...
    function renderDistrictPreview(d, kpi, cfg) {
      ...
      return `<article class="panel district-preview">
        ...
        <div class="panel-body">
          ...
          <div class="action-row">
            <button class="mini-button primary" data-profile-district="${d.name}">Туманни очиш</button>
      ...
      $("#districtsPage").innerHTML = `
        <div class="district-context">
          ...
          <div class="district-context-actions">
            ...
            <button class="mini-button primary" data-profile-district="${state.district}">Туманни очиш</button>
          </div>
        </div>
        ...
        <div class="task-summary-strip">
          ...
          <div class="small-stat"><span>Бажарилмаган топшириқ</span><strong>${taskUnfinished}/${taskSet.length}</strong><small>бажарилмаган / жами</small></div>
          <div class="small-stat"><span>Танланган ҳудуд</span><strong>${state.district}</strong><small>туман ҳолатини очиш мумкин</small></div>
        </div>
    ...
    function renderProfilePage() {
      ...
      $("#profilePage").innerHTML = `
        ...
        <div class="profile-grid">
          <article class="profile-focus">
            <div class="profile-hero">
              <div>
                ...
                <p>${cfg.description} Бу экран танланган туман бўйича кўрсаткичлар ва боғланган топшириқларни бир жойда кўрсатади.</p>
                <div class="action-row">
                  <span class="chip blue">${cfg.source}</span>
          ...
          <article class="panel">
            <div class="panel-head"><div><h3>KPI бўйича ҳаракат</h3><p>Кейинги амаллар танланган KPIга боғланган.</p></div></div>
            <div class="panel-body">
        ...
        <article class="panel" style="margin-top:16px">
          <div class="panel-head">
            <div><h3>${kpi.short}га боғланган топшириқлар</h3><p>Шу туман ва шу KPIга тегишли вазифалар кўринади.</p></div>
          ...
          <div class="panel-body">
            <div class="link-grid">
              ...
              <div class="link-box"><h3>Мониторинг</h3><p>${d.name} бўйича ${summary.unfinished} та KPI топшириқ ҳали ёпилмаган. Бу ерда KPI, вазифа ва туман маълумоти бир жойда кўринади.</p><div class="progress"><i style="--w:${summary.total ? Math.max(0, 100 - summary.unfinished / summary.total * 100) : 0}%;--c:var(--green)"></i></div></div>
            </div>
          </div>
        </article>`;
    ...
    function setPageMeta() {
      const meta = {
        ...
        report: ["Ҳисобот", "Қисқа умумлашма."]
      };
